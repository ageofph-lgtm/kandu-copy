  ...
  if (!user) {
    return (
      <div style={{minHeight:"100vh",background:"#1A1A1A",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:28,position:"relative",overflow:"hidden"}}>
        <div style={hexBg} />
        <img src="https://media.base44.com/images/public/69c166ad19149fb0c07883cb/f0a8b458b_Gemini_Generated_Image_nn24elnn24elnn24-Photoroom.png" style={{width:40, height:40, objectFit:"contain", borderRadius:8, background:"white", padding:2, marginBottom:24, position:"relative", zIndex:1}} alt="KANDU" />
      ...
      <div style={{minHeight:"100vh",background:"#1A1A1A",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{flex:1,padding:"50px 20px 20px",display:"flex",flexDirection:"column",alignItems:"center",gap:20,position:"relative",zIndex:1}}>
          ...
          <div style={{width:160,height:160,clipPath:"polygon(25% 0%,75% 0%,100% 50%,75% 100%,25% 100%,0% 50%)",background:"#1A1A1A",border:"4px solid #FF6600",boxShadow:"0 0 30px #FF660066",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
            <img src="https://media.base44.com/images/public/69c166ad19149fb0c07883cb/f0a8b458b_Gemini_Generated_Image_nn24elnn24elnn24-Photoroom.png" style={{width:32, height:32, objectFit:"contain", borderRadius:6, background:"white", padding:2}} alt="" />
  ...
  return (
    <div style={{minHeight:"100vh",background:"#1A1A1A",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",padding:"60px 20px 100px",gap:24,position:"relative",zIndex:1}}>
        <img src="https://media.base44.com/images/public/69c166ad19149fb0c07883cb/f0a8b458b_Gemini_Generated_Image_nn24elnn24elnn24-Photoroom.png" style={{width:40, height:40, objectFit:"contain", borderRadius:8, background:"white", padding:2}} alt="KANDU" />
